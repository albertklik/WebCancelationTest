<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#"><img style="height: 50px" src="{{ asset('assets/web-imgs/logo.png') }}" /></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="{{ route('home') }}">{{ __("interface.home") }} <span class="sr-only">(current)</span></a>
      </li>
      {{-- <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{ route('changeLang',['lang' => 'en']) }}">Default</a>
        </div>
      </li>
      {{-- <li class="nav-item">
